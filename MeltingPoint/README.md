...
2. シミュレーション結果を可視化するツール[VMD](https://www.ks.uiuc.edu/Research/vmd/alpha/)をあらかじめインストールしておいて下さい。動かない場合があります。その場合は、[ChimeraX](https://www.cgl.ucsf.edu/chimerax/download.html)をダウンロードします。
...
https://faq.interlink.or.jp/faq2/View/wcDisplayContent.aspx?sso_step=1&id=1373 
